...
private:
	...
	bool isGameModeRunaway{ true }; // alternative game mode where plaeyr ahs tu runawy from enemies instead of shooting them. also has to eat food to level up
	bool isGameOver{ false };
	int gracePeriodTime{ 60 * 1 }; // 1 second of grace period (because the timer is decremented every frame i.e. 60 times per second - should adapt this to higher FPS rates!
